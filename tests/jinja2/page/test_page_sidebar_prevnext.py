...
import pytest
from bulmaio_jinja2.page.sidebar.models import SidebarPrevNext
...
def context_sidebar_prevnext():
    ...
    page = pages[7]
    prev_next = page['sidebar']['prev_next']
...
@pytest.mark.parametrize(
    'page',
    [['test_page_sidebar_prevnext.html', context_no_sidebar_prevnext], ],
    indirect=True
)
...
@pytest.mark.parametrize(
    'page',
    [['test_page_sidebar_prevnext.html', context_sidebar_prevnext], ],
    indirect=True
)
